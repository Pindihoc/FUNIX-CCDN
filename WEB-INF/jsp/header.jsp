                ...
                <div class="modal-content">
                    <div class="modal-body">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item p-5 mx-auto">
                            	<c:if test="${empty cart}"><em>Your cart is empty now..</em></c:if>
                            	<c:if test="${not empty cart}">
                            		<em>Seems like you got some stuffs in your bag.</em>
                            		<p><a class="text-decoration-none" href="<c:url value="/cart"/>"><em class="float-end pt-3"> > Go check it</em></a></p>
                            	</c:if>
							</li>
                            <li class="list-group-item"><a class="text-decoration-none" href="<c:url value="/cart"/>"><em class="bi bi-bag-fill"> Cart</em></a></li>
